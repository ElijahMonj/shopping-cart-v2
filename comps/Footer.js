...
const Footer = () => {
  ...
  <footer className="py-5 container">
    <div className="row">
      <div className="col-6 col-md-2 mb-3">
        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item mb-2"><Link href="#" className="nav-link p-0 text-body-secondary">Features</Link></li>
      ...
      <div className="col-md-5 offset-md-1 mb-3">
        <form>
          ...
          <p>Monthly digest ofs new and exciting from us.</p>
    ...
    <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
      ...
      {/* 
       <li className="ms-3"><Link className="link-body-emphasis" href="#"><svg className="bi" width="24" height="24"><use xlink:href="#twitter"></use></svg></Link></li>
        <li className="ms-3"><Link className="link-body-emphasis" href="#"><svg className="bi" width="24" height="24"><use xlink:href="#instagram"></use></svg></Link></li>
        <li className="ms-3"><Link className="link-body-emphasis" href="#"><svg className="bi" width="24" height="24"><use xlink:href="#facebook"></use></svg></Link></li>
